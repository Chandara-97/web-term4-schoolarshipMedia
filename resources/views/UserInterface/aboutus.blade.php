...
<div class="row heading">
  <div class="col-md-6 col-md-offset-3">
    <h2 class="text-center bottom-line font-weight-bold">ជួបជាមួយក្រុមរបស់យើង</h2>
...
<div class="row team-row" style="margin: 0 auto;">
  ...
  <div class="col-md-6 col-sm-6 col-lg-6 team-wrap" data-aos="animate text on scroll">
    <div class="team-member text-center">
      ...
      <h6 class="team-title font-weight-bold ">លាវ ចាន់តារា</h6>
  ...
  <div class="col-md-6 col-sm-6 col-lg-6 team-wrap" data-aos="animate text on scroll">
    <div class="team-member last text-center">
      ...
      <h6 class="team-title font-weight-bold">លី ណារី</h6>
  ...
  <script>
    ...
    <div class="col-md-12 col-sm-12 col-lg-12 team-wrap item-center" data-aos="animate text on scroll">
        <div class="team-member last text-center">
            <div class="team-img" data-aos="zoom-in">
                <img src="https://z-p3-scontent.fpnh18-1.fna.fbcdn.net/v/t1.0-9/93702675_2742617472632911_8494561527477567488_o.jpg?_nc_cat=107&ccb=2&_nc_sid=8bfeb9&_nc_eui2=AeHHMBLpChYOtoqOxqCX0hMji1ksBM5ewG6LWSwEzl7AbtM8TKPcbZeTQR1-udfAvcxYVjpKNLm4aJipc9gt_WTM&_nc_ohc=CPyTePWms8cAX_cA6nA&_nc_ht=z-p3-scontent.fpnh18-1.fna&oh=b506e90eec5d3fd3443a7e6d837e07f2&oe=6025F4C2" alt="" style="width: 16rem;" class="rounded-circle border-warning">
                <div class="overlay">
                    <div class="team-details text-center">
                        <p class="text-primary">
                            និស្សិតជំនាញវិទ្យាសាស្រ្តកុំព្យូទ័រ <br>
            ...
            <h6 class="team-title font-weight-bold">មុន្នីរ័ត្នសុខឆវី</h6>

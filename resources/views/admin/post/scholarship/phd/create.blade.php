...
@section('content_header')
    <h1 class="font-weight-bold text-center text-primary">Add Post PhD</h1>
@stop

@section('content')
    <div class="container">

        <form action={{route('phd.store')}} method='post' enctype="multipart/form-data">
            @csrf
            ...
            <div>
                ...
                <a href="{{route('phd.index')}}">Cancel</a>

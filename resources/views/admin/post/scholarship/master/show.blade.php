...
@section('title','ដំណឹងអាហារូករណ៍/ថ្នាក់អនុបណ្ឌិត')
...
{{--        <span id='ct7' class=" btn btn-warning font-weight-bold" ></span>--}}
        ...
        <div  data-aos="fade-left" class="btn btn-primary rounded-pill col" >
            <h3 class="header " class="btn btn-white rounded-circle animate__animated animate__bounce" data-aos="animate text on scroll">ថ្នាក់អនុបណ្ឌិត

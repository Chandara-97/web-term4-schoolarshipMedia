...
@section('title','ដំណឹងអាហារូករណ៍/ថ្នាក់មធ្យមសិក្សា')
...
@section('post1')
    <div class="row">
        ...
        <div  data-aos="fade-left" class="btn btn-primary rounded-pill col" >
            <h3 class="header " class="btn btn-white rounded-circle animate__animated animate__bounce" data-aos="animate text on scroll">ថ្នាក់មធ្យមសិក្សា
    ...
    @foreach($highschools as $highschool)
        <section class="card rounded card-post-size" data-aos="flip-right">
            <div class="row">
                <div class="col-4"></div>
                <div class="col-3"><img src="{{asset("ScholarshiphighschoolImages/".$highschool->image)}}" class="imagepost" alt="imagepost"></div>
                <div class="col-4"></div>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="d-flex flex-column comment-section" id="myGroup">
                    <?php
                    echo $highschool->description;
                    ?>
{{--                    @include('layout.like')--}}
                </div>
                <div>
                    {{$highschool->created_at}}
                </div>
            </div>
